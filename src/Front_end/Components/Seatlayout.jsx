...
// console.log(" departure time seat layout",departuretime)
// console.log("arrival time seat layout",arrivaltime)
    ...
    return (
        ...
        <div className='mt-2 w-full max-w-lg mx-auto relative border border-gray-200 pb-2 flex  items-center justify-between'>
            <div>
                <ToastContainer />
                {/* Close Button */}
                <MdClose
                        ...
                        <div className='w-full max-w-xs  p-2 border border-gray-200 rounded-lg  '>
                            ...
                            <div className='flex flex-col'>
                                <div className='flex space-x-6  '>
                                    ...
                                    <div className='mb-2 '>
                                        <label className='block text-xs font-bold '>Date: {date.split(' ')[0]}</label>
                                    </div>
